# CONTINUATION OVERRIDE — 2026-09-22

Use the CURRENT CHECKPOINT immediately below as authoritative. Ignore older instructions below that say PR #1 is open/draft, `main` is untouched, Render is the approved deployment target, or the feature branch is the production source. Those statements are historical only.
